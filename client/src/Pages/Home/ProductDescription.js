...
const ProductDescription = () => {
  ...
  console.log(product.imageUrl && product.imageUrl[0]);
            ...
            <div className="info">
              ...
              <div className="banks d-flex ">
                <div className="bank border rounded border-secondary ">
                  <div className="bank-title  border-bottom border-secondary p-1 fontcenter">
                    HDFC Bank
                  </div>
        ...
        <div className="accordion-item bg-transparent bg-transparent mb-5 border rounded border-secondary p-3 mt-5">
          ...
          >
            <div className="accordion-body">
              ...
              <div className="fontcenter mt-4">
                <button className="border-1 p-2  border rounded  text-light">
                  View More
                </button>
              </div>
            </div>
          ...
          >
            <div className="accordion-body">
              ...
              <div className=" mt-4">
                ...
                <button className="border rounded  text-light fw-bold p-2 ps-5 pe-5">
                  Write a Review
                </button>
              </div>
              <hr />
                ...
                <div className="cust-review ">
                  ...
                  <div className="Sort">
                    ...
                    <select
                      id="cars"
                      name="cars "
                      className=" text-light p-1 border rounded"
                    >
